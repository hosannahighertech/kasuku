...
wxDECLARE_EVENT(KEVT_MEDIA_PLAY_PLAYING, wxCommandEvent);
...
private:
	...
	void OnPlayerEndReached(wxCommandEvent& e);
	void OnPlayerPlaying(wxCommandEvent& e);
